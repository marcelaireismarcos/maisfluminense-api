...
public class JogosFragment extends Fragment {
    private static final String TAG = "JogosFragment";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void onProgressChanged(WebView view, int newProgress) {
                if (progressBar != null) {
                    ...
                    progressBar.setVisibility(newProgress < 100 ? View.VISIBLE : GONE);
                }
            }
        });
        ...
        String URL = getString(R.string.linksubmenu_04);
        webView.loadUrl(URL);
    }
    ...
    public void onResume() {
        ...
        if (getActivity() instanceof Principal) {
            ...
            ((Principal) getActivity()).updateToolbarTitle(getString(R.string.menu_jogos));
        }
    }
